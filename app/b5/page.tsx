          ...
          <div className="bg-white p-5 shadow-md rounded-lg">
                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <span className="ml-2 text-gray-500">
                      (Bhuvaneshwari Plaza, Diamond Park Road)
                    </span>
                  </div>
                </div>
                <div className="flex items-center mt-2">
                  <span className="text-gray-500">Opens at 5:30 a.m.</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center mt-4">
              <div className="text-sm text-gray-700">
                ...
                <a href="07487853515" className="hover:underline">
                  07487853515
                </a>
              </div>
        ...
        <div className="p-6 bg-white m-6 rounded-lg">
          <div className="mt-10">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-2 gap-x-10">
              ...
              <li className="flex items-center">
                <span className="text-green-600 mr-2">✔</span>
                <span className="text-gray-900">ATM Services</span>
              </li>
            </ul>
          </div>
          <br />
          ...
          <div className="mt-10">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-2 gap-x-10">
              <li className="flex items-center">
                <span className="text-green-600 mr-2">✔</span>
                <span className="text-gray-900">Max number of guests-8</span>
              </li>
              <li className="flex items-center">
                <span className="text-green-600 mr-2">✔</span>
                <span className="text-gray-900">
                  No of people in one room-2
                </span>
              </li>
            </ul>
          </div>
