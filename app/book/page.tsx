    ...
    <>
      ...
      <div className="p-5 bg-amber-100 ">
          ...
          <div className="bg-white p-5 shadow-md rounded-lg">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start mt-4 md:mt-8">
              <div className="flex items-center">
                <div
                  role="button"
                  className="flex items-center text-white bg-yellow-500 px-2 py-1 rounded-lg cursor-pointer"
                >
                  <div className="text-xl font-semibold mr-2">4.2</div>
                  <svg
                    width="20"
                    height="20"
              ...
              <div className="mt-4 md:mt-0 text-sm text-gray-700">
                <div className="flex items-center">
                  ...
                  <div
                    aria-label="Mvp Colony, Visakhapatnam"
                    className="hover:underline cursor-pointer"
                  >
                    Mvp Colony, Visakhapatnam
                    <span className="ml-2 text-gray-500">
                      (Near Samata College, Apughar Road)
                    </span>
                  </div>
                </div>
            ...
            <div className="flex justify-between items-center mt-4">
              <div className="text-sm text-gray-700">
                ...
                <a href="tel:08128198752" className="hover:underline">
                  08128198752
                </a>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="grid grid-cols-2 gap-4">
                <li className="flex items-center">
                  <span className="text-green-500 mr-2">✔️</span>
                  <span className="text-lg font-medium text-gray-700">Men</span>
                </li>
                <li className="flex items-center">
                  <span className="text-green-500 mr-2">✔️</span>
                  <span className="text-lg font-medium text-gray-700">
        ...
        <div className="bg-white rounded-lg m-6 p-4">
          ...
          <a href="/feedback">
            <button className="m-2 w-20 h-8 bg-blue-700 rounded-lg text-blue-100">
              Click here
            </button>
          </a>
        </div>
      ...
      {/*<div className="p-4 m-8 bg-amber-100 border-1 border-stone-500 rounded-md shadow-md">
        <div className="text-3xl">Hostel 1</div>
        <div className=" bg-green-400 p-2 w-12 text-white text-xl font-bold rounded-md">
          4.2
        </div>
        <div className="display flex font-semibold">
          <img
            width="28"
            height="12"
        ...
        <div className="display flex bg-green-400 p-2 w-44 text-white font-bold rounded-md">
          <img width="28" height="12" src="image.png" alt="phone" />
          <a href="tel:9807654321" className="pl-2 text-lg">
            9876543210
          </a>
        </div>
      </div>*/}
